...
namespace EmployProject.Dao
{
    public class EmployDaoImpl : IEmployDao
    {
        ...
        {
            FileStream fs = new FileStream(@"E:\Wipro\Day5\Employ.txt", FileMode.Open, FileAccess.Read);
        ...
        {
            FileStream fs = new FileStream(@"E:\Wipro\Day5\Employ.txt", FileMode.Create, FileAccess.Write);
            BinaryFormatter formatter = new BinaryFormatter();
